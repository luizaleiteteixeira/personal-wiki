> **Superseded.** This is the first version, when ask mode used a single generation step. It is kept as before/after evidence; see [../ask-evidence-cards.md](../ask-evidence-cards.md) for the current two-step results.

# Ask-mode evidence cards (offline run)

**Run:** 2026-09-22, 18:21-18:23 PDT, recorded in [`offline-demo.cast`](offline-demo-v1-single-step.cast) /
[`offline-demo.gif`](offline-demo-v1-single-step.gif). The recording starts by showing `Wi-Fi Power (en0): Off`
