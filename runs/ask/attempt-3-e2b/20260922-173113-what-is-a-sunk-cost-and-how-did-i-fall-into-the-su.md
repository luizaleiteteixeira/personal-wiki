...
- Generation: 2.9 s, 1307 prompt tokens, 102 output tokens, MLX peak memory 4.32 GB

## Answer

Sunk costs are costs that cannot be recovered [S3]. They are irrelevant for future decisions [S3]. For example, this is sunk cost reasoning when money has already been spent, and continuing an action only makes the situation more uncomfortable [S1]. One example involves ordering a pizza where I forced myself to finish it because I had already paid for it [S4]. Sunk costs should be ignored in decisions, along with any other cash flows that the decision does not affect [S5].
...
- [S5] `raw/finance-summary.pdf › Lecture 13 (part 2) › p.33`
