...
- Generation: 2.47 s, 1410 prompt tokens, 70 output tokens, MLX peak memory 4.37 GB

## Answer

Sunk costs are costs that cannot be recovered [S3]. They are irrelevant for decisions [S3]. This is demonstrated when money has already been spent, and continuing an action does not change the past choice [S1]. For example, finishing a pizza after having already paid for it is an example of sunk cost reasoning [S4].
